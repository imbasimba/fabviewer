...
Healpix.prototype.neighbours = function(ipix){
...
Healpix.prototype.xyf2nest = function(ix, iy, face_num) {
//	console.log("[Healpix.prototype.xyf2nest] Math.floor(face_num<<(2*this.order)) " +Math.floor(face_num<<(2*this.order)));
//	console.log("[Healpix.prototype.xyf2nest] this.spread_bits(ix) " +Math.floor(this.spread_bits(ix)));
//	console.log("[Healpix.prototype.xyf2nest] this.spread_bits(iy)<<1 " +Math.floor(this.spread_bits(iy)<<1));
	
	return Math.floor(face_num<<(2*this.order)) 
	+ this.spread_bits(ix) + (this.spread_bits(iy)<<1); 
};

//Healpix.prototype.loc2pix = function(z, phi, sth, have_sth){
//	"use strict;"
//	var za = Math.abs(z);
...
Healpix.prototype.loc2pix = function(hploc){
	var z=hploc.z;
	var phi=hploc.phi;
	...
	var pixNo;
	if (za<=this.twothird) {//Equatorial region
//		console.log("[Healpix.prototype.loc2pix] equatorial");
		var temp1 = this.nside*(0.5+tt);
    	var temp2 = this.nside*(z*0.75);
    	var jp = Math.floor(temp1-temp2); // index of  ascending edge line
    	var jm = Math.floor(temp1+temp2); // index of descending edge line
...
//        console.log("[Healpix.prototype.loc2pix] PIXNO: "+pixNo);
    }else { // polar region, za > 2/3
//    	console.log("[Healpix.prototype.loc2pix] polar");
	    var ntt = Math.min(3,Math.floor(tt));
	    var tp = tt-ntt;
...
//	    console.log("tt "+tt+"ntt "+ntt+" tp "+tp+" tmp "+tmp+" jp "+jp+" jm "+jm);
	    if (z>=0){
//	    	console.log("[Healpix.prototype.loc2pix] z>=0");
//	    	console.log("[Healpix.prototype.loc2pix] this.nside "+this.nside);
//	    	console.log("[Healpix.prototype.loc2pix] jm "+jm);
//	    	console.log("[Healpix.prototype.loc2pix] jp "+jp);
//	    	console.log("[Healpix.prototype.loc2pix] jp "+ntt);
//	    	
//	    	console.log("[Healpix.prototype.loc2pix] Math.floor(this.nside-jm -1) "+Math.floor(this.nside-jm -1));
//	    	console.log("[Healpix.prototype.loc2pix] Math.floor(this.nside-jp-1) "+Math.floor(this.nside-jp-1));
	    	pixNo = this.xyf2nest(Math.floor(this.nside-jm -1),Math.floor(this.nside-jp-1),ntt);
	    }else{
//	    	console.log("[Healpix.prototype.loc2pix] z<0");
	    	pixNo = this.xyf2nest(Math.floor(jp), Math.floor(jm), ntt+8);
...
//Healpix.prototype.ang2pix = function(ptg){
...
Healpix.prototype.fmodulo = function(v1, v2){
	if (v1>=0){
...
Healpix.prototype.spread_bits = function(v){
